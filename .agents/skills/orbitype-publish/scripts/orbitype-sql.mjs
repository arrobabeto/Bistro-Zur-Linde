#!/usr/bin/env node
/**
 * Orbitype SQL helper (publish/mutate). Uses ORBITYPE_API_SQL_KEY (or
 ...
 *   node .agents/skills/orbitype-publish/scripts/orbitype-sql.mjs query 'SELECT ...' [--bind k=v ...]
 *   node .agents/skills/orbitype-publish/scripts/orbitype-sql.mjs mutate 'UPDATE ...' [--bind k=v ...]
 *
 * `mutate` requires RETURNING. Always confirm with the user before calling mutate.
 */

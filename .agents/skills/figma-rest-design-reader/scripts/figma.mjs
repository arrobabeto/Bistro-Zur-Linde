#!/usr/bin/env node
/**
 * Figma REST helper. Uses FIGMA_API_KEY + FIGMA_FILE_KEY from
 ...
 *   node .agents/skills/figma-rest-design-reader/scripts/figma.mjs nodes <nodeId> [nodeId...]
 *   node .agents/skills/figma-rest-design-reader/scripts/figma.mjs tree [pageNameOrId] [depth]
 *   node .agents/skills/figma-rest-design-reader/scripts/figma.mjs export <nodeId> [format=png] [scale=2]
 */
